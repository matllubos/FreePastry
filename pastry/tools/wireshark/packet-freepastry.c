...
proto_register_freepastry(void)
{
  ...
  static hf_register_info hf[] = {
    ...
    { "Number of route sets",	"freepastry.direct.route_row.numrouteset",
    FT_UINT32, BASE_DEC, NULL, 0x0,
    "", HFILL }},
    { &hf_freepastry_direct_routerow_notnull,
    { "Route set is null",	"freepastry.direct.route_row.nullrouteset",
    FT_BOOLEAN, 8, NULL, 0x0,
    "", HFILL }},
    ...
    { "Number of rows",	"freepastry.routingtable.broadcast_routerow.num_row",
    FT_UINT8, BASE_DEC, NULL, 0x0,
    "", HFILL }},
    { &hf_freepastry_routingtable_broadcast_routerow_notnull,
    { "Is not null",	"freepastry.routingtable.broadcast_routerow.not_null",
    FT_BOOLEAN, 8, NULL, 0x0,
    "", HFILL }},
