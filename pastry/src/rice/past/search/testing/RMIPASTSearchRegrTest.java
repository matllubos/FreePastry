...
public class RMIPASTSearchRegrTest {
  ...
  protected void testQuery() throws TestFailedException {
    ...
    assertEquals("testQuery", "First result should be highest-ranking",
                 results[0], url2);

    assertEquals("testQuery", "Second result should be lowest-ranking",
                 results[1], url);
    ...
    assertEquals("testQuery", "First multi result should be highest-ranking",
                 results2[0], url3);

    assertEquals("testQuery", "Second multi result should be lowest-ranking",
                 results2[1], url);
  }
