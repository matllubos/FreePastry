...
public class SSLSmtpServerImpl extends SmtpServerImpl {
  ...
  public SSLSmtpServerImpl(int port, EmailService email, boolean gateway, PostEntityAddress address, boolean acceptNonLocal, boolean authenticate, UserManager userManager, String keystore, String password, String server, boolean log, Environment env) throws Exception {
    super(port, email, gateway, address, acceptNonLocal, authenticate, userManager, server, log, env);    
