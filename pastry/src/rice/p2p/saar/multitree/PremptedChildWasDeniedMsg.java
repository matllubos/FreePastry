...
/**
 */
public class PremptedChildWasDeniedMsg extends SaarDataplaneMessage {
...
//    }
//    
//    public PremptedChildWasDeniedMsg(ReplayBuffer buffer, PastryNode pn) {
//	super(buffer,pn);
//    }


    public PremptedChildWasDeniedMsg(NodeHandle source, Topic topic, int stripeId) {
	super(source, topic);
	...
	return "PremptedChildWasDeniedMsg: " + topic + " source= " + source + " stripeId= " + stripeId ;
    }
