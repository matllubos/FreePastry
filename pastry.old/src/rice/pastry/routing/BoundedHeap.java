...
public class BoundedHeap extends Heap
{
     ...
     * Constructor.
     *
     * @param isMaximizing is the heap maximizing?
     * @param maxElts the maxmimum number of elements allowed in the heap.
     */
    
    public BoundedHeap(boolean isMaximizing, int maxElts)
    {
	super(!isMaximizing);
    ...
    {
	HeapElementInterface hei = super.insertElement(elt);
	
	if (getSize() > maxElements) extract();
