...
/**
 * This is the routing message with a routing table object.
 * 
 * @author Tsuen Wan Ngan
 */

public class RMRoutingTable implements Message
{
	private Address src;
	private Vector rt;
	...
	public RMRoutingTable(Address dest, Address src, Vector rt, long timestamp) 
	{
		super(dest);
		this.src = src;
		this.rt = rt;
