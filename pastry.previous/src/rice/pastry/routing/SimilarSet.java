...
public class SimilarSet {
    ...
    /**
     * The Comparator used for the notion of 'similarity'.
     */
	...
	theCmp = new SimilarityComparator(nid);
	Comparator cmp = new ReverseOrder(theCmp);
	
	theSM = new SelectiveMap(size, cmp);
	
	mostSimilar = new TreeSet(theCmp);
